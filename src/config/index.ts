...
export class ConfigurationManager {
  ...
  private profiles: Map<string, AzureConfiguration> = new Map();
   ...
   */
  private loadFromEnvironment(): AzureConfiguration {
    const rawConfig = {
   ...
   */
  private loadProfilesFromFile(): void {
   ...
   */
  private validateConfiguration(config: any): AzureConfiguration {
    ...
    return value as AzureConfiguration;
  }

  /**
   * Get current active configuration
   */
  public getConfig(): AzureConfiguration {
   ...
   */
  public getProfileConfig(profileName: string): AzureConfiguration {
   ...
   */
  public addProfile(name: string, config: Partial<AzureConfiguration>): void {
   ...
   */
  public async testConfiguration(profileName?: string): Promise<{ valid: boolean; error?: string }> {
    try {
